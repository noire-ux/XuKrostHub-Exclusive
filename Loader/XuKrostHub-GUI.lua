...
notify(HubName,"✅ XuKrost Hub Successfully loaded! have fun!",4)local TweenService = game:GetService("TweenService")
local StarterGui = game:GetService("StarterGui")
local UserInputService = game:GetService("UserInputService")
local HttpService = game:GetService("HttpService")
local RunService = game:GetService("RunService")
...
local mainFrame = Instance.new("Frame", screenGui)
mainFrame.Size = ORIGINAL_FRAME_SIZE -- FIX: Use stored original size
mainFrame.Position = UDim2.new(0.05, 0, 0.1, 0)
mainFrame.BackgroundColor3 = Color3.fromRGB(30,30,35)
mainFrame.Active = true
mainFrame.Draggable = true
...
creator.Position = UDim2.new(0.6, -305, 0, 0)
creator.BackgroundTransparency = 1
creator.TextXAlignment = Enum.TextXAlignment.Right
...
bubbleButton.MouseButton1Click:Connect(function()
    bubbleButton.Visible = false
    mainFrame.Visible = true
    -- FIX: Gunakan ukuran frame asli yang sudah disimpan
    TweenService:Create(mainFrame,TweenInfo.new(0.3),{Size=ORIGINAL_FRAME_SIZE}):Play()
    minimized = false
end)
